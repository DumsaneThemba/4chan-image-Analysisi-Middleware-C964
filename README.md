<h1>TUT Image Analysis </h1>

<h2> RANDOM live images will be pulled from TUT radom  location</h2>
<h2>
...
- <b>[Node.JS (backend):](https://github.com/DumsaneThemba/4chan-image-Analysisi-Middleware-C964))</b> control data flow between all components
- <b>[React (frontend):](https://https://github.com/DumsaneThemba/C964-WGU-BSCS-Capstone-React)</b> single page application (SPA)
